    ...
    return [
      ...
      },
      {
        ...
        final_push: [
          ...
          `They arrive outside the house of ${story.boss}, ${story.leadA.name}'s boss at the ${story.leadA.industry} company,`,
          `and start singing Christmas carols.`,
          `${story.boss} is so overcome with the spirit of Christmas,`,
    ...
    return [
      {
        ...
        final_push: [
          ...
          `${story.boss}, ${story.leadA.name}'s boss from the ${story.leadA.industry} company jumps down from one of the bulldozers smoking a cigar.`,
          `Overwhelmed by the spirit of Christmas in the town,`,
          `the demolition is called off,`,
          `and he agrees to give ${story.leadB.name} and ${story.leadA.name} the money they need to keep the ${story.shop} in business.`,
        ],
      },
      {
        setup,
      ...
      },
      {
        ...
        final_push: [
          ...
          `${story.boss}, ${story.leadA.name}'s boss at the ${story.leadA.industry} company is furious,`,
      ...
      },
      {
        ...
        final_push: [
          ...
          `${story.boss}, ${story.leadA.name}'s boss at the ${story.leadA.industry} company jumps down from one of the bulldozers,`,
